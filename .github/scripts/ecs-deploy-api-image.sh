#!/usr/bin/env bash
# Register a new ECS task definition revision with the given image, then update the service.
set -euo pipefail
...
echo "ECS service $SERVICE updated with image $IMAGE_URI"
